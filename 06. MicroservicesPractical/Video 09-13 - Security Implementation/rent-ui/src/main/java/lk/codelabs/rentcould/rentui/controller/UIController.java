package lk.codelabs.rentcould.rentui.controller;

import com.jalitha.rentcloud.commons.model.Customer;
import lk.codelabs.rentcould.rentui.config.AccessToken;
...
public class UIController extends WebSecurityConfigurerAdapter {
    ...
    public String loadCustomers(Model model) {
        ...
        try {
            ResponseEntity<Customer[]> responseEntity = restTemplate.exchange("http://localhost:9199/service/customers", HttpMethod.GET, customerHttpEntity, Customer[].class);
